...
import { PropertycertificateComponent } from './propertycertificate/propertycertificate.component';
...
export class SinglepropertyComponent implements OnInit {
  ...
  cert_data : any;
     ...
     opendialog(): void { 
      ...
      const dialogRef = this.dialog.open(PropertycertificateComponent, {
        width: '60vw',
        height: '50vw',
        panelClass: 'mydialog',
        data : this.cert_data

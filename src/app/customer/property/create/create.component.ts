...
export class CreateComponent implements OnInit {
  ...
  constructor(private propertyService: PropertyService, private snackBar: MatSnackBar, private authService: AuthenticationService,
    private router: Router, private route: ActivatedRoute, public dialog: MatDialog, private imageService: ImageService, private userService: UserService) {
  ...
  addProperty() {
    ...
    this.propertyService.addProperty(this.property).subscribe((data: Property) => {
      ...
      this.router.navigate(['/user/property/view'])
      ...
      console.log(error);
      if (error.status == 422 || error.message == 'Property with same name already exist') {

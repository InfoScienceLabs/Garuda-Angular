...
export class NetworkComponent implements OnInit {
  ...
  constructor( public dialogRef : MatDialogRef<NetworkComponent>,
                @Inject(MAT_DIALOG_DATA) public network_data :any, 
  ...
  ngOnInit() {
    ...
    // this.network_data[0].public.receipt.gasUsed = (parseInt(this.network_data[0].public.receipt.gasUsed) / 1e9).toFixed(6);
